...
if choice == "Acute GVHD prediction":
    ...
    # Recipent age
    Recipent_age = st.number_input("Donor age", min_value=0, max_value=120, value=30)

    # Donor age
    Donor_age = st.number_input("Donor age", min_value=0, max_value=120, value=30, key = 12324)
